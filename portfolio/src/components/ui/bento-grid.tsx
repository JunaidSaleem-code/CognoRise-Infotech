...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-col-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background: "rgb(3,0,45)",
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(3,3,86,1) 16%, rgba(2,103,166,1) 78%, rgba(0,212,255,1) 100%)",
      }}
    >
